...
async function loadImageAsDataUrl(url: string): Promise<string | null> {
  // Client-only: fetch image and convert to data URL.
  // Removed Node fs fallback because it caused Vercel output tracing to include the entire project
  // and bundled a hard-coded Windows absolute path that doesn't exist on Vercel's Linux build.
  try {
