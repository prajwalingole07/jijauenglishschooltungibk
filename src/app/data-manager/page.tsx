...
export default function DataManager(){
  ...
  const { students, faculties, staff, attendance, teacherAttendance, homework, transactions, salaryRecords, portalAccounts, notices, holidays, settings, syncNow, isSyncing } = useStore();
