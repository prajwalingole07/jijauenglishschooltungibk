...
export const metadata: Metadata = {
  ...
  description: "JIJAU ENGLISH SCHOOL - Digital Management System. Admin, Founder & Teacher portals. Vercel-ready PWA & APK (Web2App).",
  manifest: "/manifest.json",
  appleWebApp: { capable: true, statusBarStyle: "black-translucent", title: "Jijau Portal" },
